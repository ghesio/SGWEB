...
<html lang="en">
  <head>
    ...
    <script src="js/bootstrap.js"></script>
    <!-- I2c JS -->
    <script src="SGWEB/i2c.js"></script>
    ...
    <body>
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="spacer"></div>
          <div class="col-xs-12">
            <h2 class="text-center">I2C Temperature brick sensor</h1>
          </div>
          <div class="row">
            <div class="col-xs-6 text-center">
              <button type="button" onClick="readTemp();" name="refresh2">Refresh</button>
            </div>
          <div class="col-xs-6">
